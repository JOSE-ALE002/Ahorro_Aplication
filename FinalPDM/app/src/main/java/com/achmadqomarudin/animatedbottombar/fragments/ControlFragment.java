...
public class ControlFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        ConnectionHelper connHelper = new ConnectionHelper(this.getContext()); //Conexion a la base de datos
       ...
       //******************************************* SELECTOR DE HORA ****************************************
                ...
                btnGuardar.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        long id = dbTran.insertarTransaccion("Gasto",etPlannedDate.getText().toString(),"Efectivo" ,"Comida",50.50,TxtNotas.getText().toString());
